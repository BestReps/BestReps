function reorganizeSheetData() {
  try {
    ...
    const sourceData1 = sourceSheet1.getRange(1, 1, sourceSheet1.getLastRow(), 10).getValues();
    const sourceData2 = sourceSheet2.getRange(1, 1, sourceSheet2.getLastRow(), 10).getValues();
    ...
    newSheet.getRange(1, 1, allData.length + 1, 4).setBorder(true, true, true, true, true, true);
